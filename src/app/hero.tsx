...
const Hero = () => {
  return (
    <section className="hero-backdrop relative overflow-hidden">
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col-reverse items-center gap-10 px-6 py-12 sm:py-24 lg:min-h-[calc(100vh-var(--nav-h))] lg:flex-row lg:gap-16">
        ...
        <Reveal delay={150} className="relative w-full max-w-[260px] sm:max-w-[300px] lg:w-auto lg:max-w-none lg:flex-shrink-0">
          ...
          <div className="relative overflow-hidden rounded-[1.75rem] border border-brand-divider bg-white p-2 shadow-accent-deep">
            <Image
              src="/pai-2.jpg"
